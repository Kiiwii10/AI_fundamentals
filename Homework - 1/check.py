...
def solve_problems(problems):
    ...
    for problem in problems:
        try:
            p = ex1_.create_onepiece_problem(problem)
        except Exception as e:
        ...
        result = check_problem(
            p, (lambda p: search_.astar_search(p, p.h)), timeout)

        print(f"A* problem {counter} ", result)
        counter = counter + 1
        if result[2] != None:
            if result[0] != -3:
                solved = solved + 1
...
def main():
    ...
    problems = [
        ...
        },
        {
            ...
            'marine_ships': {'marine_1': [(4, 1), (4, 2)], 
                             'marine_2': [(3, 5), (3, 4), (4, 4)],
                             'marine_3': [(1, 2), (1, 3), (1, 4)], 
                             'marine_4': [(5, 6)]},
        },


        # additional inputs by course staff
